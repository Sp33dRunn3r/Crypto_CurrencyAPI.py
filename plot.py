...
def Plotpoint1():
    table_trace = go.Table(
        ...
        cells=dict(values=[binance_price().index[:], binance_price()['Open'], binance_price()['High'], binance_price()['Low'], binance_price()['Close'], binance_price()['Volume'], binance_price()['Number_of_trades']],
    ...
    trace3 = go.Scatter(
        x=binance_price().index[:],
        y=binance_price()['Number_of_trades'],
        xaxis='x3',
        yaxis='y3',
